...
- Name: calculator.spec.js >> Nounoutrice E2E Tests >> Test 4: Toggles change labels and functionality
- Location: tests/calculator.spec.js:34:3
...
Call log:
  - waiting for getByText('2 enfants')
