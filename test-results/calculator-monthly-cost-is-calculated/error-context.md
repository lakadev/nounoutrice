...
- Name: calculator.spec.js >> monthly cost is calculated
- Location: tests/calculator.spec.js:40:1
...
Locator: locator('text=Coût mensuel')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Coût mensuel')
