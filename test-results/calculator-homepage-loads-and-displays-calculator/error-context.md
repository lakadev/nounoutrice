...
- Name: calculator.spec.js >> homepage loads and displays calculator
- Location: tests/calculator.spec.js:3:1
...
Locator: locator('text=Nounoutrice')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Nounoutrice')
