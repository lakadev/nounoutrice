...
- Name: calculator.spec.js >> calculates hours correctly
- Location: tests/calculator.spec.js:13:1
...
Locator: locator('strong:has-text("35h")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('strong:has-text("35h")')
